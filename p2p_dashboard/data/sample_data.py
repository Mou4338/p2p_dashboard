...
All currency references use 'Rs' (Indian Rupees) without emoji symbols.
"""
import pandas as pd
import numpy as np
...
def get_pr_data():
    ...
    for i in range(1, 31):
        ...
        rows.append({
            ...
            "Quantity":        qty,
            "UOM":             uom,
            "Est. Value (Rs)": round(qty * price, 2),
...
def get_po_data():
    ...
    for i in range(1, 26):
        ...
        rows.append({
            ...
            "PO Value (Rs)":  round(qty * net_price, 2),
            "PO Date":        fmt(po_dt),
...
def get_gr_data():
    ...
    for i in range(1, 21):
        ...
        rows.append({
            ...
            "UOM":          uom,
            "Value (Rs)":   round(qty_recv * price, 2),
...
def get_invoice_data():
    ...
    for i in range(1, 21):
        ...
        rows.append({
            ...
            "Base Amt (Rs)":  base_amt,
            "Tax %":          tax_pct,
            "Tax Amt (Rs)":   tax_amt,
            "Total Amt (Rs)": round(base_amt + tax_amt, 2),
            "Status":         status,
...
def get_payment_data():
    ...
    for i in range(1, 18):
        ...
        rows.append({
            ...
            "Status":       status,
            "Cleared By":   random.choice(["F110 - Auto Payment", "F-53 - Manual"]),
        })
    return pd.DataFrame(rows)
